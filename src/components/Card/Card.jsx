  ...
  return (
    <div className="Card">
      ...
      <div className="card-content">
        ...
        <span>
          {" "}
          This is a very long text that should only take up three lines at most.
          After the third line, it will automatically be truncated and show an
          ellipsis to prevent it from overflowing or breaking the layout of the
          container.
        </span>
      </div>
        ...
        <div>
          ...
          >
            ...
            <g transform="scale(0.8) translate(3,3)">
              ...
              />
              <path
                d="M6 20c0-4 6-4 6-4s6 0 6 4v1H6v-1z"
                fill="url(#userGrad)"
                stroke="rgba(0,0,0,0.08)"
                stroke-width="0.15"
              />
